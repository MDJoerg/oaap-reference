...
echo ""
echo "The app containers are STOPPED for the copy and restarted right"
echo "after. Connections through them break at $AT -- pick an hour where"
echo "that is acceptable, and tell whoever runs a long-lived client."
echo ""
